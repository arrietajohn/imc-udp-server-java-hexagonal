...
public class CanalUdp {
   ...
   *
   * <p>El socket se toma prestado y no debe cerrarse en este método, porque su
   * ciclo de vida abarca todas las operaciones realizadas entre {@link #abrir(int)}
   * y {@link #cerrar()}.
   */
   ...
   *
   * <p>El socket se toma prestado; {@link #cerrar()} conserva la responsabilidad
   * exclusiva de liberar el recurso y de interrumpir una recepción bloqueada.
   */
  @SuppressWarnings("resource")
